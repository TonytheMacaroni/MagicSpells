...
public class VolatileGlowManagerLatest extends PacketBasedGlowManager<Packet<?>, ClientboundSetEntityDataPacket, ClientboundSetPlayerTeamPacket> {
	...
	@Override
	protected ClientboundSetPlayerTeamPacket createJoinTeamPacket(@NotNull GlowData data) {
		try {
	...
	@Override
	protected ClientboundSetPlayerTeamPacket createResetTeamPacket(org.bukkit.scoreboard.@NotNull Scoreboard scoreboard, @NotNull GlowData data) {
		try {
	...
	private class GlowChannelHandler extends ChannelOutboundHandlerAdapter {
		...
		public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
			if (msg instanceof Packet<?> p && handled.remove(p)) {
