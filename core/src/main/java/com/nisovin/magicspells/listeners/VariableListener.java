...
public class VariableListener implements Listener {
	...
	public void onJoin(PlayerJoinEvent event) {
		...
		try (var _ = MagicDebug.section(DebugCategory.VARIABLES, "Loading variables on login for player '%s'.", player.getName())) {
	...
	public void onQuit(PlayerQuitEvent event) {
		...
		try (var _ = MagicDebug.section(DebugCategory.VARIABLES, "Saving variables on quit for player '%s'.", name)) {
