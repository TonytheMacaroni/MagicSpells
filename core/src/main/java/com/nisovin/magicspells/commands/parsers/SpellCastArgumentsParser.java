...
public class SpellCastArgumentsParser implements ArgumentParser.FutureArgumentParser<CommandSourceStack, String[]>, SuggestionProvider<CommandSourceStack> {
	...
	@Override
	public @NonNull CompletableFuture<@NonNull ArgumentParseResult<String[]>> parseFuture(@NonNull CommandContext<CommandSourceStack> context, @NonNull CommandInput input) {
	...
	@Override
	public @NonNull CompletableFuture<@NonNull ? extends Iterable<@NonNull ? extends Suggestion>> suggestionsFuture(@NonNull CommandContext<CommandSourceStack> context, @NonNull CommandInput input) {
