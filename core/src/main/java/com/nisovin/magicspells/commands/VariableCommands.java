...
public class VariableCommands {
	...
	private static void show(CommandContext<CommandSourceStack> context) {
		...
		try (var _ = MagicDebug.section("Showing variable '%s'.", variableName)) {
	...
	private static void modify(CommandContext<CommandSourceStack> context) {
		...
		try (var _ = MagicDebug.section("Modifying variable '%s'.", variableName)) {
			...
			try (var _ = MagicDebug.section("Resolving variable mod '%s'.", variableModString)) {
