...
public enum ModifierType {
	...
	REQUIRED(false, "required", "require") {
		...
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'required' modifier action.")) {
				if (!check) {
	...
	DENIED(false, "denied", "deny") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'denied' modifier action.")) {
				if (check) {
	...
	POWER(true, "power", "empower", "multiply") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'power' modifier action.")){
				if (check) {
	...
	ADD_POWER(true, "addpower", "add") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'addpower' modifier action.")){
				if (check) {
					float oldPower = event.getPower();
	...
	COOLDOWN(true, "cooldown") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'cooldown' modifier action.")) {
				if (check) {
	...
	REAGENTS(true, "reagents") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'reagents' modifier action.")) {
				if (check) {
	...
	CAST_TIME(true, "casttime") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'casttime' modifier action.")) {
				if (check) {
	...
	STOP(false, "stop") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'stop' modifier action.")) {
	...
	CONTINUE(false, "continue") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'continue' modifier action.")) {
	...
	CAST(true, "cast") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'cast' modifier action.")) {
				if (check) {
	...
	CAST_INSTEAD(true, "castinstead") {
		...
		@Override
		public boolean apply(SpellCastEvent event, boolean check, CustomData customData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'castinstead' modifier action.")) {
				if (check) {
					CastData data = (CastData) customData;
	...
	VARIABLE_MODIFY(true, "variable") {
		...
		private void modifyVariable(boolean check, CustomData customData, SpellData spellData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'variable' modifier action.")) {
				if (!check) {
	...
	STRING(true, "string") {
		...
		private void setVariable(boolean check, CustomData customData, SpellData spellData) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'string' modifier action.")) {
				if (!check) {
					MagicDebug.info("Condition failed - continuing.");
					return;
				}
	...
	MESSAGE(true, "message") {
		...
		private void sendMessage(boolean check, CustomData customData, LivingEntity caster, SpellData data) {
			try (var _ = MagicDebug.section(DebugCategory.MODIFIERS, "Performing 'message' modifier action.")) {
				if (!check) {
					MagicDebug.info("Condition failed - continuing.");
					return;
				}
